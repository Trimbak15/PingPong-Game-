...
public class GamePanel extends JPanel implements Runnable{
    ...
    private void newPaddles() {
        paddle1=new Paddle(0,height/2-Paddle_Height/2,Paddlle_Width,Paddle_Height,1);
        paddle2=new Paddle(width-Paddlle_Width,height/2-Paddle_Height/2,Paddlle_Width,Paddle_Height,2);
    }
